...
RSpec.describe Alimento do
  ...
  before :each do
    ...
    #Metodo for  para el array de la  practica 10(imperativo)
   ...
   array
    ...
    #Metodo each para el array de la practica 10 (funcional)
      ...
      array
        ...
        #Array alimento para la practica 10
    @Tabla = [  Alimento.new('Huevo Frito',14.1,0.0,19.5,'lacteos'),Alimento.new('Plátano',1.2,21.4,0.2,'frutas'),
        Alimento.new('Leche',3.3,4.8,3.2,'lacteos'),Alimento.new('Cerdo',21.5,0.0,6.3,'carnes'),
        Alimento.new('Bacalao',17.7,0.0,0.4,'pescado'),Alimento.new('Aceite',0.0,0.2,99.6,'al_graso'),
    Alimento.new('Azúcar',0.0,99.8,0.0,'al_carbohidratos'),Alimento.new('Tomate',1.0,3.5,0.2,'verduras'),
   ]
  end
  ...
  describe "# Comparar atributos de alimentos " do
   ...
   describe "# Obtener indice gluceimo " do
    ...
    it "Metodo para el calculo del Indice Glucemico" do
        ...
        datos = [[6.7, 6.5, 6.8, 6.9, 7.0, 7.1, 6.9, 6.9, 6.9, 6.7, 6.9, 7.3, 7.0, 7.0, 7.2, 7.1, 6.8, 7.2 ,7.3 ,7.0 ,6.8 ,
        6.7, 6.8, 6.7, 6.9],[4.6 ,4.8 ,5.3, 5.6, 6.1, 6.5, 6.6, 7.0, 7.0, 6.8, 6.4, 6.3, 6.1, 6.1, 6.2, 6.0, 6.1, 6.1 ,6.2, 6.3,
        6.4 ,6.1 ,6.1 ,5.7 ,5.9]]
        gluc = [[4.9 ,5.3 ,5.9 ,6.7 ,7.2 ,7.6 ,8.0 ,8.2, 8.2 ,8.4 ,8.3 ,8.3 ,8.0 ,7.5, 7.1, 6.8 ,6.8 ,6.9, 6.8, 6.3 ,6.2,
        6.3 ,6.2 ,6.3, 6.1],[6.3, 5.4, 5.6, 5.7, 6.5, 7.4, 7.9, 7.4, 7.7, 7.9, 7.9, 7.8, 7.8, 7.8, 8.0, 8.5, 9.4 ,10.8 ,10.5,
        9.1, 8.9, 8.3, 7.7, 7.6 ,7.5]]
          @manzana.calculate_index(datos,gluc)
            expect(@manzana.ind_gluc).to eq(54.499780077077745)
    end
  end
  describe "Ordenaciones" do
    it "Benchmark" do
      Benchmark.bmbm do |test|
        test.report("Con el metodo sort\n")  { @Tabla.dup.sort }
        test.report("Con el metodo for\n") {bubblesort_for(@Tabla.dup)}
        test.report("Con el metodo each \n") {bubblesort_each(@Tabla.dup)}
       end
      end
    end
end
